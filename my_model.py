...
# flattens layers output into a one-dimensional vector
model.add(Flatten())
# dense connects neurons togather and provides no-linearity
model.add(Dense(512,activation = "relu"))
# dropout focuses the train on only important neurons and skips unimportant ones
model.add(Dropout(.5))
...
checkpoint = ModelCheckpoint(
    filepath=f"saved_models/my_model_checkpoint.hdf5",
