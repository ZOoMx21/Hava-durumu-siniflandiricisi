...
base_model = tf.keras.applications.EfficientNetV2S(input_shape=img_shape, include_top=False, weights = "imagenet")
...
checkpoint = ModelCheckpoint(
    filepath=f"saved_models/EfficientNetV2S_checkpoint.hdf5",
