...
checkpoint = ModelCheckpoint(
    filepath=f"saved_models/ResNet50V2_checkpoint.hdf5",
...
plt.legend()
plt.tight_layout
plt.savefig('validation/ResNet50V2_validation.png')

preds = model_inc.predict(ts_gen)
...
plt.savefig('confusion_matrix/ResNet50V2_matrix.png')

report_text = classification_report(ts_gen.classes, y_pred, target_names= classes)
fig, ax = plt.subplots(figsize=(5, 4))
ax.axis('off')
ax.text(0, 0.5, report_text, ha='left', va='center', wrap=True)
